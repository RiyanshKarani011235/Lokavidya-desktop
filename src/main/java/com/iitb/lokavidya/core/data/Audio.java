...
public class Audio implements Serializable {
	...
	public Audio(String audioURL,String projectURL) {
		...
		try {
			FileUtils.copyFile(new File(audioURL), new File(projectURL,audioName+"."+FilenameUtils.getExtension(audioURL)));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		this.setAudioURL(new File(projectURL,audioName+"."+FilenameUtils.getExtension(audioURL)).getAbsolutePath());
		setAudioProperties();
	}
...
//		}
    	String pathExecutable = FFMPEGWrapper.pathExecutableffprobe;
    	JsonObject jobj = null;
